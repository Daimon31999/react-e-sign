  ...
  <Toolbar>
    <div
      ...
      <div class="mr-2 flex items-center">
        <img src="img/line_height.svg" class="w-6 mr-2" alt="Line height" />
        <input
          type="number"
          min="1"
          max="10"
      ...
      <div class="mr-2 flex items-center">
        <img src="img/text.svg" class="w-6 mr-2" alt="Font size" />
        <input
          type="number"
          min="12"
          max="120"
      ...
      <div class="mr-2 flex items-center">
        <img src="img/text-family.svg" class="w-4 mr-2" alt="Font family" />
      ...
      <div
        ...
        <img class="w-full h-full" src="img/delete.svg" alt="delete object" />
      </div>
    </div>
  </Toolbar>
{/if}
